...
def _process_chunk(chunk, h0, h1, h2, h3, h4):
    ...
    for i in range(80):
        ...
        print("EricS: rotl5 = ",hex(_left_rotate(a, 5)))
        print("EricS: f = ",hex(f))
        print("EricS: k = ",hex(k))
        print("EricS: w[i] = ",hex(w[i]))
        print("\n")
        a, b, c, d, e = ((_left_rotate(a, 5) + f + e + k + w[i]) & 0xffffffff, 
                        a, _left_rotate(b, 30), c, d)
    
    # Add this chunk's hash to result so far
    print("EricS: round = final")
    print("EricS: a = ",hex(a))
    print("EricS: b = ",hex(b))
    print("EricS: c = ",hex(c))
    print("EricS: d = ",hex(d))
    print("EricS: e = ",hex(e))
    print("\n")
    print("EricS: h0 = ",hex(h0))
    print("EricS: h1 = ",hex(h1))
    print("EricS: h2 = ",hex(h2))
    print("EricS: h3 = ",hex(h3))
    print("EricS: h4 = ",hex(h4))
    print("\n")
    h0 = (h0 + a) & 0xffffffff
    h1 = (h1 + b) & 0xffffffff 
    h2 = (h2 + c) & 0xffffffff
...
class Sha1Hash(object):
    ...
    def _produce_digest(self):
        ...
        print("EricS: message = ",binascii.hexlify(message))
        #print("EricS: message = ", hex(message))
