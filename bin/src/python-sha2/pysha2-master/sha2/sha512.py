...
class sha512(object):
    ...
    def _sha512_process(self, chunk):
        ...
        for i in range(80):
            ...
            print("EricS: round = ",i)
            print("EricS: s0 = ",hex(s0))
            print("EricS: s1 = ",hex(s1))
            print("EricS: maj = ",hex(maj))
            print("EricS: t1 = ",hex(t1))
            print("EricS: t2 = ",hex(t2))
            print("EricS: ch = ",hex(ch))
            print("EricS: kpw = ",hex(kpw))
            print("EricS: k = ",hex(self._k[i]))
            print("EricS: w = ",hex(w[i]))
            print("\n")
